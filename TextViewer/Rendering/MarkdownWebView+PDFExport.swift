...
/// Adds a "Text Viewer" pane to the system print panel holding the font
...
private final class PrintSizeAccessoryController: NSViewController, NSPrintPanelAccessorizing {
    ...
    init(exportFormat: DocumentExportFormat? = nil) {
        ...
        title = NSLocalizedString("Text Viewer",
...
extension MarkdownWebView {
    ...
    /// format selector in the Text Viewer accessory pane.
    func exportDocument(
        markdown: String,
        sourceURL: URL?,
        assetBaseURL: URL?,
    ...
    /// "Text Viewer" accessory pane so the panel's own live page

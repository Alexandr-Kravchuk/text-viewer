...
extension DocumentWindowController {
    ...
    private func saveUntitledText(
        ...
        panel.message = NSLocalizedString(
            "Choose a name and location for the new text file.",
            comment: "New text file panel prompt"
        )
    ...
    private func performPendingEditorCommit(body: String,
        ...
        if currentFileURL == nil {
            saveUntitledText(body) { result in
    ...
    private func persistEditedMarkdown(
        ...
        panel.message = NSLocalizedString(
            "Text Viewer needs your permission to save this file.",

...
//  md-preview
//
//  Resolves text-viewer:// URLs — the custom scheme browsers and other apps
...
nonisolated enum ExternalOpenScheme {
    ...
    ///
    ///     text-viewer://file/Users/me/notes.txt
    ///     text-viewer:///Users/me/notes.txt
    ///
    /// and resolves to the file the percent-decoded path names
    /// (`My%20Notes` → `My Notes`). Returns nil only for a malformed
    /// text-viewer:// link — another host, an empty path — so the caller

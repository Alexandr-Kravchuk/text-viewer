        ...
        Form {
            Section {
                LabeledContent {
                    ...
                    Text(L("Text size"))
                    Text(L("Text size in document windows."))
                }
            ...
            Section {
                Toggle(isOn: $model.isAlwaysOnTop) {
                    ...
                    Text(L("Keeps every Text Viewer window in front of other apps, including windows you open later. A window in full screen is left alone until it comes back out."))
                }
            ...
            Section {
                ...
                Text(L("Adds text-viewer and tv to your PATH. Run it again after updating the app to refresh the commands."))
            }
        }
        .formStyle(.grouped)
        .onAppear {
